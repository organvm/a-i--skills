...
1. **Skill Library** -- A browsable catalog of 164 skills across 12 categories, from algorithmic art generation to security threat modeling, each with standardized metadata, optional helper scripts, reference documentation, and asset templates.
...
```
a-i--skills/
├── skills/                           # 160 example skills, organized by category
...
│   └── tools/                        # 20 skills (agent swarms, skill creation, meta-tools)
│
...
The 164 skills are organized into 12 categories. Each category below lists skill count and representative examples.

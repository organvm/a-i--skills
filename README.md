...
1. **Skill Library** -- A browsable catalog of 161 skills across 12 categories, from algorithmic art generation to security threat modeling, each with standardized metadata, optional helper scripts, reference documentation, and asset templates.
...
```
a-i--skills/
├── skills/                           # 157 example skills, organized by category
...
│   └── tools/                        # 18 skills (agent swarms, skill creation, meta-tools)
│
...
The 161 skills are organized into 12 categories. Each category below lists skill count and representative examples.

...
organ_affinity: [all]
triggers: [user-asks-premortem, user-asks-poke-holes, user-asks-stress-test, user-asks-blind-spots, context:high-cost-decision, context:pre-launch]
complements: [evaluation-to-growth, security-threat-modeler, contract-risk-analyzer, project-alchemy-orchestrator, systemic-product-analyst]
---

...
triggers: [user-asks-schedule, user-asks-recurring-task, user-asks-cron, user-asks-remind-me, context:repeated-task]
complements: [agent-swarm-orchestrator, project-orchestration, cross-agent-handoff]
---
